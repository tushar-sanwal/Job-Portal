...
<head>
   <meta charset="utf-8">
    ...
    <title>employer_registration</title>
...
<body style="color:rgb(0,0,0);">
    ...
    <div>
        <nav class="navbar navbar-default navigation-clean" style="background-color:#000;">
            <div class="container">
                <div class="navbar-header"><a class="navbar-brand text-capitalize" href="#" style="font-size:28px;color:#fff;">Getjob</a><button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button></div>
                <div
                    ...
                    <ul class="nav navbar-nav navbar-right" style="color:#ffffff;font-size:6px;">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" style="font-size:17px;color:rgb(255,255,255);">Register With Us<span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu" style="background-color:rgb(33,37,41);">
                                ...
                                <li role="presentation"><a href="" style="color:rgb(255,255,255);">Employer Register</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" style="font-size:17px;color:rgb(255,255,255);"><i class="glyphicon glyphicon-log-in"></i>&nbsp;Login<span class="caret"></span></a>
                            <ul class="dropdown-menu"
                                ...
                                <li role="presentation"><a href="#" style="color:rgb(255,255,255);">User Login</a></li>
                                <li role="presentation"><a href="#" style="color:rgb(255,255,255);">Employer Login</a></li>
                            </ul>
                        </li>
                    </ul>
            </div>
...
<h2><center>Employer Registration</center></h2>
<tr>
    <td>First Name</td>
